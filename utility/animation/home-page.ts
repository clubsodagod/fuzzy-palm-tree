...
export const useMotionLogic = (scrollY: MotionValue, homeEventPoints: number[]) => {
    ...
    const developer_scale = [useRVs([36, 48, 48]), useRVs([72, 96, 96]), useRVs([72, 96, 96]), 96, 0, 0, 0, 0, 0];
    const developer_x = [0, 0, 7, 0, 3, 0, 0, 0, 0];
    const developer_y = [0, 0, useRVs([-5, -5, -5]), useRVs([-35, -30, -35]), 0, 0, 0, 0, 0];
    const developer_z = [1, 0, 0, 0, 0, 0, 0, 0, 0];
    const developer_rotation_y = [0, 0, -1, 2, 0, 0, 0, 0, 0];
