...
export default function CoinGrowth(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene" scale={5} rotation={[1,0,0]}>
        ...
        <group name="Coins" position={[0.007, 4.507, -1.43]} rotation={[-Math.PI / 2, 0, 0]} scale={0.01}>
        ...
        <mesh name="CoinsGroup_CoinGroup_0" geometry={nodes.CoinsGroup_CoinGroup_0.geometry} material={materials.CoinGroup} position={[0.109, 0.043, -1.94]} scale={0.01} />
