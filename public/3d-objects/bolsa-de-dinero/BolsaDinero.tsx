...
export default function BolsaDinero(props: JSX.IntrinsicElements['group']) {
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="GLTF_SceneRootNode">
          <group name="BOLSA_MONEY_0" position={[0, 0.8, 0]} rotation={[Math.PI / 2, 0, 0]}>
            <mesh name="Object_4" geometry={nodes.Object_4.geometry} material={materials.mat0_SIMBOLO} />
            <mesh name="Object_5" geometry={nodes.Object_5.geometry} material={materials.mat0_CUERDA} />
            <mesh name="Object_6" geometry={nodes.Object_6.geometry} material={materials.mat0_BILLETE} />
            <mesh name="Object_7" geometry={nodes.Object_7.geometry} material={materials.mat0_BOLSA} />
            <mesh name="Object_8" geometry={nodes.Object_8.geometry} material={materials.mat0_MONEDAS} />
          </group>
        </group>
      </group>
    </group>
