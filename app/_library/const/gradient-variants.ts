...
export const gradientVariants = {
    ...
    'programmer-why-digital-dynamic-four': {
        background: 'radial-gradient(#0f9b0f,#0f9b0f, #000000)',
        backgroundSize: '400% 400%',
        backgroundPosition: '0% 0%',
        animation: 'animate-area-bg 6s ease-in-out infinite alternate',
    },
    ...
    'approach-main': {
        background: `radial-gradient(#3D4E81,#5753C9,#6E7FF3)`,
        backgroundSize: '200% 200%',
        backgroundPosition: '0% 0%',
        animation: 'animate-main-bg 10s infinite alternate',
    },
    'approach-solid-principles': {
    ...
    'approach-design-patterns': {
        background: 'radial-gradient(#091E3A,#2F80ED,#2D9EE0)',
        backgroundSize: '200% 200%',
        backgroundPosition: '100% 0%',
        animation: 'animate-approach-bg 8s ease-in-out infinite alternate',
    },
    ...
    'web-mobile-application': {
        background: 'radial-gradient(circle at center, #0052D4,#4364F7,#6FB1FC)',
        backgroundSize: '200% 200%',
        backgroundPosition: '150% 150%',
        animation: 'animate-approach-bg 8s ease-in-out infinite alternate',
    },
    ...
    'about-bio': {
        background: `radial-gradient( #7F7FD5,#86A8E7,#91EAE4)`,
        backgroundSize: '200% 200%',
        backgroundPosition: '0% 0%',
        animation: 'animate-main-bg 10s infinite alternate',
    },
